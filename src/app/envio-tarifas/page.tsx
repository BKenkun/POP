...
export default function EnvioTarifasPage() {
  return (
    <div className="max-w-4xl mx-auto space-y-8">
        ...
        <Card>
            <CardHeader>
                <CardTitle className="flex items-center gap-3"><Truck className="h-6 w-6"/>Envío de tu Paquete</CardTitle>
            </CardHeader>
        ...
        <div className="space-y-6">
            ...
            <Card>
                <CardHeader>
                     <CardTitle className="flex items-center gap-3"><MapPin className="h-6 w-6"/>Tarifas de Envío</CardTitle>
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="flex items-center gap-3"><Globe className="h-6 w-6"/>Envíos al Resto del Mundo</CardTitle>
                </CardHeader>
                 <CardContent>
                    <Table>
