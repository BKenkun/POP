      ...
      <div className="border-t border-border/40 pt-12 mt-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <h3 className="font-semibold text-lg">Pago Discreto</h3>
            <p className="text-muted-foreground text-sm">No aparecerá el nombre de la web en tu extracto bancario.</p>
          </div>
          <div className="flex flex-col items-center gap-3">
